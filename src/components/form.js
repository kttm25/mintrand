...
function Form({selectedImage, setSelectedImage, ipfs, loading, setLoading}) {
    const [addressValue, setAddressValue] = useState('4PGC6SU4YL4JVQIOX4CQSYFSAF5VLKUUPP4KC47ZK25I3QJDBBBB3PTV6C')
    const [addressError, setAddressError] = useState(false)
    const [skValue, setSKValue] = useState('[30, 104, 54, 27, 134, 128, 82, 206, 12, 139, 126, 62, 205, 2, 192, 111, 210, 181, 77, 68, 248, 0, 93, 152, 118, 138, 194, 249, 70, 241, 203, 11, 227, 204, 47, 74, 156, 194, 248, 154, 193, 14, 191, 5, 9, 96, 178, 1, 123, 85, 170, 148, 123, 248, 161, 115, 249, 86, 186, 141, 193, 35, 8, 66]')
    ...
    const [managerValue, setManagerValue] = useState('4PGC6SU4YL4JVQIOX4CQSYFSAF5VLKUUPP4KC47ZK25I3QJDBBBB3PTV6C')
